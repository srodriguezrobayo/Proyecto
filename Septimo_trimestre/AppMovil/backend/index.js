...
//         conexion.query(query, [Servicio_idServicio, Fecha_reservacion, Hora_reservacion, Lugar_reservacion_idLugar_reservacion, Cant_person, Condiciones,Empresa_Nit_Empresa, Cliente_id_Cliente, Valor, Estatus,Empleados_id_empleado], (error) => {
//             if (error) {
//                 console.error(error.message);
...
app.get('/olvido_contrasena/Cliente/:Correoelectronico_cliente', (req, res) => {
    const { Correoelectronico_cliente } = req.params;


    const query = `SELECT * FROM cliente WHERE Correoelectronico_cliente = '${Correoelectronico_cliente}';`;
...
app.get('/olvido_contrasena/Empresa/:Correoelectronico_empresa', (req, res) => {
    const { Correoelectronico_empresa } = req.params;


    const query = `SELECT * FROM empresa WHERE Correoelectronico_empresa = '${Correoelectronico_empresa}';`;
...
app.get('/olvido_contrasena/Admin/:Nom_empleado', (req, res) => {
    const { Nom_empleado} = req.params;


    const query = `SELECT * FROM empleados WHERE Nom_empleado = '${Nom_empleado}';`;
...
//Algunas consultas de la app movil
//Obtener los ID
...
app.get('/obtenerCliente/:id', (req, res) => {
    ...
    const query = `SELECT cliente.*, ciudad.nombre_ciudad AS NombreCiudad,
                    genero.Desc_genero AS GeneroDesc
                      FROM cliente
                      JOIN ciudad ON cliente.Ciudad_id_Ciudad = ciudad.id_Ciudad
                      JOIN genero ON cliente.Genero_idGenero = genero.idGenero
...
app.get('/obtenerEmpresa/:id', (req, res) => {
    ...
    const query = `SELECT empresa.*, ciudad.nombre_ciudad AS NombreCiudad
                        FROM empresa
                        JOIN ciudad ON empresa.Ciudad_id_Ciudad = ciudad.id_Ciudad
                    WHERE empresa.Nit_Empresa = ${id};`
    conexion.query (query, (error, resultado) => {
        if (error) return console.error (error.message)
...
app.get('/obtenerReserva/:id', (req, res) => {
    const { id } = req.params
