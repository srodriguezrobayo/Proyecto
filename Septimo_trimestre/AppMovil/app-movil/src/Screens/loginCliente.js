...
const LoginCliente = ({ navigation }) => {
    ...
    const loginCliente = () => {
        LoginCliente(Correo, Contraseña)
    ...
    return (
        <View style={styles.contenido}>
            ...
            <ScrollView>
                ...
                />
                <Pressable style={styles.btnNuevaCita} onPress={loginCliente}>
                ...
                <Text style={styles.texto}>
                    ...
                    <Text style={styles.textoBold} onPress={() => navigation.navigate("RegistroCliente")}>
                        Registrate
                    </Text>
                </Text>
            </ScrollView>
