...
const AgregarLugarReservacion = ({ navigation }) => {
  ...
  const agregarLugares = () => {
    var config = {
      method: "post",
      url: `http://10.0.2.2:9300/lugar_reserva/agregar`,
      data: {
      ...
      <View style={styles.container}>
        ...
        <ScrollView>
          ...
          <View style={styles.botones}>
            <Pressable style={styles.btn} onPress={agregarLugares}>
...
export default AgregarLugarReservacion;
