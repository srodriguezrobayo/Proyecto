...
@Component({
  selector: 'app-ver-reserva-completo-c',
  templateUrl: './ver-reserva-completo-c.component.html',
  styleUrls: ['./ver-reserva-completo-c.component.css']
})
export class VerReservaCompletoCComponent implements OnInit {
