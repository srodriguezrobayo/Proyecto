...
//genero
  ...
  tiempo(Empresa_Nit_Empresa: string, Fecha_reservacion: string) {
    return this.http.get<ReservacionModel>(`${this.BASE_URL}/tiempo/${Empresa_Nit_Empresa}/${Fecha_reservacion}`);
  }
  obtenernombreadmin(){
    return sessionStorage.getItem('Nom_Empleado')
  }
}