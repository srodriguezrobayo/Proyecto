...
insert into lugar_reservacion(idLugar_reservacion,Nom_lugreserv,Direccion_lugreserv,Ciudad_id_Ciudad)
values ('1','Hotel tequendama','DG 48 D BIS SUR','Bogota');
insert into lugar_reservacion
	values
('2','Hotel el campin','carrera 10 59-41','Santa Marta'),
	      ('3','hotel royale','Carrera 54 85-39 norte','bello'),
	      ('4','hotel starfish','Calle 43 36-48 sur','La estrella'),
	      ('5','hotel whashigton','Calle 123 # 45-67','Medellin'),
	      ('6','salon comunal bosa','Carrera 45 dig 85','Barranquilla'),
	      ('7','salon comunal florida','Avenida 52g -58','santo tomas'),
	      ('8','hotel jeferson','Carrera 456 # 78-90','cartagena'),
	      ('9','hotel vercetti','Avenida 789 Sur # 12-34','soledad'),
	      ('10','Edificio atrio','Diagonal 321 # 56-78','santa rosa'),
	      ('11','hotel Bioxury','Transversal 654 # 90-12','Facatativa'),
	      ('12','hotel Eldorado','Calle 987 Este # 34-56','El pinon'),
	      ('13','hotel Cosmos','Avenida 567 Norte # 12-34','Turbaco'),
	      ('14','SENA','Avenida 765 Sur # 34-56','Funsagasuga'),
	      ('15','hotel Morrison','Diagonal 098 # 67-89','Santa Ana');
...
insert reservacion
	values (10,5,'2023-07-20','18:00 pm',1,15227896,1,200000,55),
	(20,6,'2023-07-15','20:00 pm',2,15227898,2,500000,74),
	(30,7,'2023-07-10','17:00 pm',3,55475457,3,400000,79),
	(40,8,'2023-07-19','12:00 am',4,87877448,4,1000000,92);

SELECT D.idDepartamento, C.id_Ciudad, L.idLugar_reservacion,L.Nom_lugreserv,L.Direccion_lugreserv
from departamento D
inner JOIN ciudad C
...
on R.Lugar_reservacion_idLugar_reservacion = L.idLugar_reservacion
